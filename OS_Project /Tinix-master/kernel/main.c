...
///////////////////////////////////////////////////////////////////////////////
	...
	disp_str("             QAAAAAAAAAAAAAAAAAAAAAAQA\n");
	disp_str("             QAAAAAAAAAAAAAAAAAAAAAAQAA\n");
    disp_str("             QAAAAAAAAAAAAAAAAAAAAAAQAAA\n");
	disp_str("             QAAAAAAAAAAAAAAAAAAAAAAQAAAA\n");
	disp_str("             QAAAAAAAAAAAAAAAAAAAAAAQAAAA\n");
	disp_str("             QAAAAAAAAAAAAAAAAAAAAAAQAAAA\n");
	disp_str("             QAAAAAAAAAAAAAAAAAAAAAAQAAAAAAA\n");
	disp_str("             QAAAAAAAAAAAAAAAAAAAAAAQAAAAAAAAA\n");
	...
	milli_delay(1000);
	clearScreen();
	disp_str("^_^  Welcom To TACNIX  O(∩_∩)O~~\n");
	disp_str("Created By \n");
	disp_str("Mendy Xue, Fowafolo An, XudongLiu\n");
	disp_str("**********************************\n");
}
